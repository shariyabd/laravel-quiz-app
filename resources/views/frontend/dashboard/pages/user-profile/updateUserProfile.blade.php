                                        ...
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                ...
                                                <div class="nk-block-des">
                                                    <p>Basic info, like your name and address, that you use on this
                                                        Platform.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="nk-data data-list">
                                            ...
                                            <form action="{{ route('userProfileUpdate') }}" method="POST"
                                                ...
                                                <input type="text" value="{{ Auth::guard('user')->user()->name }}"
                                                    ...
                                                    placeholder="Name :">
                                                <input type="email"value="{{ Auth::guard('user')->user()->email }}"
                                                    name="email" id="email" class="form-control mb-3"
                                                    placeholder="Email :">
                                                <input type="file" name="image" id="image"
                                                    class="form-control mb-3" placeholder="Name :"
                                                    onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])">
                                                <img id="output"
                                                    src="{{ asset('frontend/image/' . Auth::guard('user')->user()->image) }}"

        ...
        <li class="dropdown user-dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <div class="user-toggle">
                    <div class="user-avatar sm">
                        <img src="{{ asset('frontend/image/' . Auth::guard('user')->user()->image) }}" class="rounded-circle" alt="User Image">   
                    </div>
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                ...
                <div class="dropdown-inner">
                    <ul class="link-list">
                        <li><a href="{{route('userProfile')}}"><em
                ...
                <div class="dropdown-inner">
                    <ul class="link-list">
                        <li>
                            <a class="btn btn-default btn-flat btn-block" href=""
                    ...
                    document.getElementById('admin-logout-form').submit();">Log
                        ...
                        {{-- <li><a href="{{route('admin.login.show')}}"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li> --}}
                    </ul>
                </div>
            </div>
        </li><!-- .dropdown -->
